...
$ServerMods = @('StackMax', 'PortalMenu', 'QuickBrew', 'GrowTime', 'BerryFarm', 'PartialSleep', 'InfiniteTorch', 'NoStumps', 'EasyTaming', 'FriendlyBallista', 'BigPillars', 'LagGuard', 'RuneBreaker')
